...
class Certificates extends StatefulWidget {
  ...
  const Certificates({Key key, this.onCertificateSelected, this.hint}) : super(key: key);
  ...
  Future<void> installCertificate() async {
    ...
    if (filePickerResult != null) {
      ...
      if (password != null && password.isNotEmpty) {
        ApiResponse<Certificate> response = await Native.installCertificate(file, password);
      ...
      builder: (context, snapshot) {
        ...
        return Stack(
          children: [
                ...
                return Stack(
                  ...
                  children: [
                    if (snapshot.data.isNotEmpty)
                      ...
                      const Center(child: Text("Список сертификатов пуст")),
                    GestureDetector(
            ...
            if (snapshot.data) const LockWidget() else Container()
          ],
        );
      },
    );
